...
#--------------------------------------------------
# Program: 12_orf_prediction.from_05.rb
...
inifile.each_section do |section|
	...
	contig_ex_fa_ = "#{dir_05_}/contig.updated.#{query_label}.#{l_thre}.extended.fa"
	...
	f_qsub.puts "PRODIGAL_=\"#{dir_tools_}/Prodigal-GoogleImport/prodigal\""
